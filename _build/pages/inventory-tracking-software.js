...
<section class="stats-strip" aria-label="Key results">
  <div class="stats-grid">
    <div>
      ...
      <div class="stat-label">stock levels that shift with every customer order</div>
    </div>
    <div>
      <div class="stat-number">24/7</div>
      <div class="stat-label">order capture, so late orders still count against stock</div>
    </div>
    <div>
      ...
      <div class="feature-row reverse">
        <div>
          ...
          <ul class="feature-bullets mt-24">
            ...
            <li>
              <span class="bullet-check">✓</span>
              <span>Order guides use your prices and your SKUs</span>
            </li>
            <li>
              <span class="bullet-check">✓</span>
          ...
          <a href="https://www.voiceordersolutions.com/contact-us" class="feature-link">See catalog updates →</a>
        </div>
        <div>
          <div class="img-placeholder tall">
      ...
      <div class="feature-row">
        <div>
          ...
          <ul class="feature-bullets mt-24">
            ...
            <li>
              <span class="bullet-check">✓</span>
              <span>Orders are confirmed before they reach your team</span>
            </li>
            <li>
              <span class="bullet-check">✓</span>
            ...
            <li>
              <span class="bullet-check">✓</span>
              <span>Stock moves with each order, with no re-keying</span>
            </li>
          </ul>
      ...
      <div class="feature-row reverse">
        <div>
          ...
          <p class="mt-12 text-muted">
            ...
            You see what's available, what's running low and what needs attention,
            without adding work to anyone's day.
          </p>
          <ul class="feature-bullets mt-24">
            <li>
              <span class="bullet-check">✓</span>
            ...
            <li>
              <span class="bullet-check">✓</span>
              <span>Runs next to the software you use today</span>
            </li>
          </ul>
          <a href="https://www.voiceordersolutions.com/contact-us" class="feature-link">See the full-catalog view →</a>
        </div>
        <div>
          <div class="img-placeholder tall">
  ...
  <div class="container">
    ...
    <div class="cards-grid">
      ...
      <div class="feature-card">
        ...
        <p class="text-muted mt-12" style="font-size:15px;">
          Customers call out their order in the app. VOS turns it into a clean
          digital order, with nothing to transcribe.
        </p>
      </div>

      <div class="feature-card">
        <div class="feature-card-icon">🔄</div>
        <h4>Orders Move the Numbers</h4>
        <p class="text-muted mt-12" style="font-size:15px;">
          Inventory updates alongside each order, so your counts keep up
      ...
      <div class="feature-card">
        ...
        <p class="text-muted mt-12" style="font-size:15px;">
          Each account gets its own list: the items it buys, at your prices,
          tied to your SKUs.
        </p>
      </div>
...
<section class="section-pad" id="how-it-works" aria-label="How it works">
  <div class="container">
    <div class="text-center" style="max-width: 560px; margin: 0 auto;">
      ...
      <h2>Most distributors are live within two days</h2>
      <p class="lead mt-16">
    ...
    <div class="steps-grid">
      ...
      <div class="step-card">
        ...
        <p class="text-muted mt-12" style="font-size:15px;">
          Send us each account's order guide. We load it into the admin
          platform with your items, prices and SKUs.
        </p>
      </div>
      ...
      <div class="step-card">
        ...
        <p class="text-muted mt-12" style="font-size:15px;">
          We provision every account. Customers download the app, and most
          place a first order the same day.
        </p>
      </div>
...
<section class="section-pad" id="integrations" aria-label="Integrations">
  <div class="container text-center">
    ...
    <p class="text-muted mt-24" style="font-size:14px;">
      ...
      so orders and inventory data move without anyone retyping them.
    </p>
