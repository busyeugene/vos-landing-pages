...
module.exports = {
  ...
  description: 'Restaurant purchasing software that puts your VOS suppliers in one app. Order by voice at any hour, and each order is confirmed, numbered and timestamped.',
...
<section class="hero" aria-label="Hero">
  <div class="hero-grid">
    ...
    <div>
      ...
      <p class="lead mt-16">
        VoiceOrder Solutions is restaurant purchasing software that gathers every
        supplier you use on VOS into one app. Say your order out loud, check each line, and send it with its own order number. Your food distributors set it up: each
        one adds your account and a custom order guide with the items you buy.
      </p>
      ...
      <div class="hero-trust">
        ...
        <span>Your agreed prices stay</span>
        <span class="hero-trust-dot"></span>
...
<section class="stats-strip" aria-label="Key results">
  <div class="stats-grid">
    <div>
      ...
      <div class="stat-label">is when most kitchens start ordering, after setup</div>
    </div>
    <div>
      <div class="stat-number">20-30 Min</div>
      <div class="stat-label">trimmed from each order versus a call to your rep</div>
    </div>
    <div>
  ...
  <div class="container text-center">
    ...
    <div class="problem-grid">
      ...
      <div class="problem-card">
        ...
        <p class="text-muted" style="font-size:15px;">
          You called it in, and nothing was written down. When a case is missing or something else shows up, it's your word against theirs.
        </p>
      </div>
      ...
      <div class="feature-row">
        <div>
          ...
          <p class="mt-12 text-muted">
            Fewer portals and phone numbers to juggle. VOS is food purchasing software for restaurants that comes through the distributors you already buy from. When one of your distributors joins, they
            add you, and their guide appears beside the others. Your manager learns one routine for every VOS supplier.
          </p>
          <ul class="feature-bullets mt-24">
            <li><span class="bullet-check">✓</span><span>Switch between suppliers on VOS without switching apps</span></li>
            <li><span class="bullet-check">✓</span><span>The same steps for every order, whoever it goes to</span></li>
            <li><span class="bullet-check">✓</span><span>Each supplier receives orders by email, EDI, API or QuickBooks, whichever it uses</span></li>
      ...
      <div class="feature-row reverse">
        <div>
          ...
          <p class="mt-12 text-muted">
            ...
            its own number, date and time, so it stands in for a PO with no extra form. If a delivery is
          ...
          <ul class="feature-bullets mt-24">
            ...
            <li><span class="bullet-check">✓</span><span>Check a delivery against your order confirmation</span></li>
      ...
      <div class="feature-row">
        <div>
          ...
          <p class="mt-12 text-muted">
            ...
            ordered what. As a restaurant purchasing system for small groups, VOS keeps the sender's name on each order, along with the time.
          </p>
          <ul class="feature-bullets mt-24">
            <li><span class="bullet-check">✓</span><span>No more guessing which kitchen sent an order</span></li>
    ...
    <div>
      <div class="feature-row reverse">
        <div>
          ...
          <a href="/catalog-management-software" class="feature-link">See how distributors manage the guides you order from →</a>
        </div>
        <div>
          <div class="img-placeholder tall">
...
<section class="section-pad bg-light" aria-label="Additional features">
  <div class="container">
    <div class="text-center" style="max-width: 580px; margin: 0 auto;">
      ...
      <h2>More that comes with ordering in VOS.</h2>
      <p class="lead mt-16">One app for every supplier on VOS, with these built in.</p>
    </div>
    ...
    <div class="cards-grid">
      ...
      <div class="feature-card">
        <div class="feature-card-icon">📦</div>
        <h4>Catalog Kept in Step With Stock</h4>
        <p class="text-muted mt-12" style="font-size:15px;">
          Each supplier's catalog tracks its stock, so fewer shorts and swaps arrive without warning.
        </p>
      </div>
      ...
      <div class="feature-card">
        ...
        <p class="text-muted mt-12" style="font-size:15px;">
          Your POS and accounting tools stay put. All that changes is how
          orders get to your suppliers.
        </p>
      </div>
...
<section aria-label="Mid-page call to action" style="background:var(--color-light-bg);border-top:1px solid #e4e7ed;border-bottom:1px solid #e4e7ed;padding:48px 24px;">
  <div style="max-width:var(--max-width);margin:0 auto;display:flex;align-items:center;justify-content:space-between;gap:40px;flex-wrap:wrap;">
    <div style="max-width:580px;">
      <h3 style="margin-bottom:10px;">See how buying from several suppliers works in one app</h3>
      <p class="text-muted" style="font-size:16px;">
        Our walkthrough takes 20 minutes and costs nothing. We'll walk through
        order records and how supplier guides get set up. Does your distributor already
  ...
  <div class="container">
    <div class="text-center" style="max-width: 560px; margin: 0 auto;">
      ...
      <p class="lead mt-16">
        ...
        ordering works the same way with each one on VOS.
      </p>
    </div>
  ...
  <div class="container">
    <div class="text-center" style="max-width: 700px; margin: 0 auto;">
      ...
      <p class="lead mt-16">
        ...
        manager. VOS is restaurant purchasing software that sticks to getting
        the order out.
      </p>
    </div>
    ...
    <div style="overflow-x:auto; margin-top: 0;">
      <table class="comparison-table">
        ...
        <tbody>
          <tr>
            <td>Your suppliers in one app</td>
            <td>Those on VOS</td>
          ...
          <tr>
            ...
            <td>Your chef or manager</td>
            <td>Someone trained on it</td>
            <td>Whoever has time</td>
          </tr>
          <tr>
            <td>How soon you can order</td>
            <td>Same day for most</td>
            <td>After setup and training</td>
            <td>Right away</td>
          </tr>
        </tbody>
        <tfoot>
    ...
    <div class="faq-list" style="max-width: 760px; margin: 0 auto;">
      ...
      <div class="faq-item">
        ...
        <div class="faq-answer">
          No. You keep every distributor you buy from and the prices you have agreed with them. This restaurant purchasing software reaches restaurants through those distributors:
      ...
      <div class="faq-item">
        ...
        <div class="faq-answer" style="display:none;">
          Yes, for each distributor that uses VOS. You choose the supplier, place
          the order in the same app, and VOS passes it on in the format that
          supplier already takes. Suppliers not on VOS keep taking orders from
          you as they do now.
        </div>
      </div>
      ...
      <div class="faq-item">
        ...
        <div class="faq-answer" style="display:none;">
          Not as a separate document. You confirm each order, and before it reaches the supplier, VOS gives it a number and the time it was sent. That confirmed order works as your purchase record. If a delivery does not match, that order number is your reference.
        </div>
      </div>
      ...
      <div class="faq-item">
        ...
        <div class="faq-answer" style="display:none;">
          Every order in VOS records who placed it and when. If each site's manager orders on their own phone, that manager's name is on every order from their site. Your distributor can explain how guides work when you run more than one location.
        </div>
      </div>
      ...
      <div class="faq-item">
        ...
        <div class="faq-answer" style="display:none;">
          Usually the same day your distributor finishes your setup. They handle your
...
<section class="final-cta" id="demo" aria-label="Sign up call to action">
  <h2>Ready for one app across all your VOS suppliers?</h2>
  <p>Check with your distributor about getting set up, including any cost to you, or have us show you a demo first. Stop juggling calls and portals, and get a numbered record of each order you place.</p>
  ...
  <div class="final-cta-trust">
    <span>✓ First order usually the same day</span>
