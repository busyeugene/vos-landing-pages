...
module.exports = {
  ...
  relatedHeading: 'More on placing orders, restocking and purchasing',
  body: `
<!--@NAVBAR-->
...
<section class="hero" aria-label="Hero">
  <div class="hero-grid">
    ...
    <div>
      ...
      <p class="lead mt-16">
        VoiceOrder Solutions is restaurant checklist software for one job: ordering. You get it through your distributor, who adds your usual items to the app. Whoever is on shift says the order from that list, not a paper sheet. Cleaning and opening lists stay in the tools you use now.
      </p>
      ...
      <div class="hero-trust">
        ...
        <span>Ordering on day one, for most</span>
        <span class="hero-trust-dot"></span>
    ...
    <div>
      ...
      <div class="img-placeholder tall">
        📸 Product screenshot:<br>Order guide with<br>quantities filled in,<br>ready to review
      </div>
    </div>
...
<section class="stats-strip" aria-label="Key results">
  <div class="stats-grid">
    <div>
      ...
      <div class="stat-label">is when most kitchens are ordering, once set up</div>
    </div>
    <div>
    ...
    <div>
      ...
      <div class="stat-label">saved each time you skip the phone call</div>
    </div>
  </div>
</section>
...
<section class="section-pad" id="features" aria-label="Feature details">
  <div class="container">
    ...
    <div class="text-center" style="max-width: 760px; margin: 0 auto 72px;">
      <span class="eyebrow">Same Steps, Every Time</span>
      ...
      <div class="feature-row">
        <div>
          ...
          <p class="mt-12 text-muted">
            ...
            the order." VOS is where that line actually gets done. Your distributor sets up the list for you in VOS, so there is no checklist for
          ...
          <ul class="feature-bullets mt-24">
            ...
            <li><span class="bullet-check">✓</span><span>What you normally order, waiting each time you open it</span></li>
          </ul>
          <a href="/catalog-management-software" class="feature-link">Learn how order guides are kept up to date →</a>
        </div>
        <div>
          <div class="img-placeholder tall">
            📸 Screenshot:<br>Account order guide listing<br>this restaurant's items<br>and prices
          </div>
        </div>
      </div>
    </div>
    ...
    <div style="padding-bottom: 80px; border-bottom: 1px solid #e8eaed; margin-bottom: 80px;">
      <div class="feature-row reverse">
        <div>
          ...
          <p class="mt-12 text-muted">
            The same guide opens whether your chef is in or on vacation. It lists every item you usually buy, so whoever covers goes down the same list and checks the shelves to see how much to order. Your ordering stops depending on who remembers what.
          </p>
          <ul class="feature-bullets mt-24">
            ...
            <li><span class="bullet-check">✓</span><span>No texts to the chef asking what to order</span></li>
        ...
        <div>
          <div class="img-placeholder tall">
            📸 Screenshot:<br>Order saved part way,<br>ready to pick up<br>where it stopped
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="feature-row">
        <div>
          ...
          <p class="mt-12 text-muted">
            ...
            and types it in again later. That copy step is where ordering
            mistakes creep in.
          </p>
          <ul class="feature-bullets mt-24">
        ...
        <div>
          <div class="img-placeholder tall">
            📸 Screenshot:<br>Voice order in progress<br>with items added as<br>they are spoken
          </div>
        </div>
      </div>
    </div>
    ...
    <div>
      <div class="feature-row reverse">
        <div>
          ...
          <p class="mt-12 text-muted">
            Every location orders in the same app with the same steps, from the guide your distributor maintains. For owners, it is restaurant owner checklist software that keeps a record without paper: each order gets its own number and a time stamp once it's sent.
          </p>
          <ul class="feature-bullets mt-24">
            <li><span class="bullet-check">✓</span><span>Every site runs the order the same way</span></li>
            <li><span class="bullet-check">✓</span><span>No site has to write its own list</span></li>
            <li><span class="bullet-check">✓</span><span>A confirmation text or push alert after each send</span></li>
            <li><span class="bullet-check">✓</span><span>Each site orders from a phone, not by calling it in</span></li>
          </ul>
          <a href="/restaurant-purchasing-software" class="feature-link">See how to buy from your suppliers on VOS →</a>
        </div>
        <div>
          <div class="img-placeholder tall">
            📸 Screenshot:<br>Order confirmation with<br>order number, date<br>and timestamp
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="cards-grid">
      ...
      <div class="feature-card">
        ...
        <p class="text-muted mt-12" style="font-size:15px;">
          Each VOS order names the person who sent it and the time, so there is a clear record behind it.
        </p>
      </div>
      ...
      <div class="feature-card">
        ...
        <p class="text-muted mt-12" style="font-size:15px;">
          Your distributor's product list tracks their stock, which means fewer shorts or swaps catch you by surprise.
        </p>
      </div>

      <div class="feature-card">
        <div class="feature-card-icon">📱</div>
        <h4>Deals From Your Distributor</h4>
        <p class="text-muted mt-12" style="font-size:15px;">
          Promos can arrive by text message or push notification, so whoever
          does the ordering sees them.
        </p>
      </div>
      ...
      <div class="feature-card">
        <div class="feature-card-icon">🎯</div>
        <h4>The Right Item Each Time</h4>
        <p class="text-muted mt-12" style="font-size:15px;">
          Each line is tied to your distributor's own item code, so every shift
          orders the same product, not a close guess.
        </p>
      </div>

      <div class="feature-card">
        <div class="feature-card-icon">📍</div>
        <h4>Any Spot in the Building</h4>
        <p class="text-muted mt-12" style="font-size:15px;">
          Order on your phone from the office, the dock or the bar, with no
  ...
  <div class="container">
    ...
    <div class="steps-grid">
      ...
      <div class="step-card">
        ...
        <p class="text-muted mt-12" style="font-size:15px;">
          They set up your order list and give you an app login.
        </p>
      </div>
      ...
      <div class="step-card">
        ...
        <p class="text-muted mt-12" style="font-size:15px;">
          Get VoiceOrder Solutions on iOS or Android. Most kitchens are placing
          orders before that day is over.
        </p>
      </div>

      <div class="step-card">
        <div class="step-number">3</div>
        <h4>Your team runs it every shift</h4>
        <p class="text-muted mt-12" style="font-size:15px;">
          Look over the shelves, talk through the order, review it and send. Same
          routine, whoever is on.
        </p>
      </div>
    ...
    <div class="img-placeholder mt-48" style="min-height: 280px; max-width: 860px; margin-left: auto; margin-right: auto;">
      📸 Screenshot: VOS order review screen, checked before the order is sent
    </div>
  </div>
</section>
      ...
      <div style="display: flex; flex-direction: column; gap: 24px;">
        ...
        <div class="testimonial-card">
          ...
          <p class="testimonial-quote" style="font-size:16px;">
            "When my chef is off, ordering doesn't fall apart anymore. Whoever
            covers opens the same guide and the order comes out the same."
          </p>
          <div class="testimonial-author">
            <div class="author-avatar">Photo</div>
            <div>
        ...
        <div class="testimonial-card">
          <div class="testimonial-stars">★★★★★</div>
          <p class="testimonial-quote" style="font-size:16px;">
            "New managers don't learn the order from memory now. The list is on
            the phone, and it goes to our distributor the same way each time."
          </p>
          <div class="testimonial-author">
            <div class="author-avatar">Photo</div>
            <div>
...
<section class="section-pad bg-mid" id="comparison" aria-label="Comparison">
  <div class="container">
    <div class="text-center" style="max-width: 720px; margin: 0 auto;">
      ...
      <h2>Built for ordering.<br>Not a general task app.</h2>
      <p class="lead mt-16">
        A task app can remind someone to do the order. As restaurant checklist software, VOS is where the order gets built, checked and sent. For temperature logs and staff to-do
        lists, use a tool made for that. Here's how the three compare, including where task apps win.
      </p>
    </div>
      ...
      <table class="comparison-table">
        <thead>
          <tr>
            ...
            <th style="width:21%;">General Task App</th>
        ...
        <tbody>
          ...
          <tr>
            <td>Your distributor keeps the list current</td>
            <td><span class="check-yes">✓</span></td>
          ...
          <tr>
            <td>Check and confirm the order before it goes out</td>
            <td><span class="check-yes">✓</span></td>
            <td><span class="check-no">✗</span></td>
            <td>By eye, before the call</td>
          </tr>
          <tr>
    ...
    <div class="faq-list" style="max-width: 760px; margin: 0 auto;">
      ...
      <div class="faq-item">
        ...
        <div class="faq-answer">
          ...
          checklists, a dedicated task app is the better fit.
        </div>
      </div>
      ...
      <div class="faq-item">
        ...
        <div class="faq-answer" style="display:none;">
          ...
          distributor. Whoever is on shift walks the storeroom, says how much is needed, checks the order and sends it. If a delivery arrives
      ...
      <div class="faq-item">
        ...
        <div class="faq-answer" style="display:none;">
          Anyone you trust with ordering. That way, the order no longer hangs on one person being in that day. Each order also shows the sender and when it went out.
        </div>
      </div>
      ...
      <div class="faq-item">
        ...
        <div class="faq-answer" style="display:none;">
          Yes. Every site uses the same app and the same steps, so ordering works the same way at each one. Ask your distributor how they set up accounts and order guides for more than one location.
        </div>
      </div>
      ...
      <div class="faq-item">
        ...
        <div class="faq-answer" style="display:none;">
          ...
          ordering step only, so there is nothing for you to rip out.
        </div>
      </div>
...
<section class="final-cta" id="demo" aria-label="Sign up call to action">
  <h2>Ready to make ordering the same job on every shift?</h2>
  <p>Ask your food distributor to set you up on VOS, or talk to us and we'll find the right contact for you.</p>
  ...
  <div class="final-cta-trust">
    <span>✓ Setup through your distributor</span>
    <span>✓ Ordering open 24/7</span>
    <span>✓ No change to your POS or task app</span>
...
<footer class="footer" role="contentinfo">
  <div class="footer-grid">
    ...
    <div class="footer-col">
      <h5>Features</h5>
      <ul role="list">
        <li><a href="#features">Personal Order Guides</a></li>
        <li><a href="#features">Shift-Proof Routine</a></li>
        <li><a href="#features">Walk and Talk</a></li>
    ...
    <div class="footer-col">
      ...
      <ul role="list">
        ...
        <li><a href="#comparison">VOS vs Task Apps</a></li>
      </ul>
    </div>
