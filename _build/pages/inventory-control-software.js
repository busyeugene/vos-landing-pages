...
<section class="hero" aria-label="Hero">
  <div class="hero-grid">
    ...
    <div>
      ...
      <p class="lead mt-16">
        A lot of lost margin starts at the order: a wrong quantity, a line you can't
        fill, a dispute nobody can settle. VoiceOrder Solutions is inventory
        control software that fixes the order first. Buyers approve it first, it
        arrives numbered and timestamped, and what they can order tracks what
        you have.
      </p>
...
<section class="stats-strip" aria-label="Key results">
  <div class="stats-grid">
    <div>
      ...
      <div class="stat-label">saved on each order you no longer take by phone</div>
    </div>
    <div>
      <div class="stat-number">Every</div>
      <div class="stat-label">order your customer approves before sending</div>
    </div>
    <div>
      ...
      <div class="feature-row reverse">
        <div>
          ...
          <p class="mt-12 text-muted">
            ...
            make. VOS ties stock to each order the moment it is placed, and the catalog
          ...
          <ul class="feature-bullets mt-24">
            <li><span class="bullet-check">✓</span><span>Stock numbers shift the moment a customer orders</span></li>
      ...
      <div class="feature-row">
        <div>
          ...
          <p class="mt-12 text-muted">
            ...
            at the source. Every order also carries an order number plus a date and timestamp,
      ...
      <div class="feature-row reverse">
        <div>
          ...
          <p class="mt-12 text-muted">
            ...
            paying for order mistakes. VOS was made for distributors of your size, not
            for large enterprise firms. Your customers get an app
  ...
  <div class="container">
    ...
    <div class="cards-grid">
      ...
      <div class="feature-card">
        ...
        <p class="text-muted mt-12" style="font-size:15px;">
          Handle every account, and the guide it orders from, in a single admin platform. Small
      ...
      <div style="display: flex; flex-direction: column; gap: 24px;">
        ...
        <div class="testimonial-card">
          ...
          <p class="testimonial-quote" style="font-size:16px;">
            "Every order we get is already confirmed by the customer. When someone says
    ...
    <div class="faq-list" style="max-width: 760px; margin: 0 auto;">
      ...
      <div class="faq-item">
        ...
        <div class="faq-answer" style="display:none;">
          ...
          stock. VOS is the ordering app for your restaurant and store accounts, with inventory
      ...
      <div class="faq-item">
        ...
        <div class="faq-answer" style="display:none;">
          Plan on 24 to 48 hours to go live, with no IT project on your side. Most
          customers place their first app order on launch day.
        </div>
      </div>
